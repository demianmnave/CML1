...

{
    ...
    /* Subvector: */
    size_t N = w.size();
    vector_type::subvector_type sub1 = cml::subvector(w, N-1);
    vector_type::subvector_type xsub1(1.,2.,3.);
    equal_or_fail(sub1, xsub1);
    vector_type::subvector_type sub2 = cml::subvector(w, N-2);
    vector_type::subvector_type xsub2(1.,2.,4.);
    equal_or_fail(sub2, xsub2);
    vector_type::subvector_type sub3 = cml::subvector(w, N-3);
    vector_type::subvector_type xsub3(1.,3.,4.);
    equal_or_fail(sub3, xsub3);
    vector_type::subvector_type sub4 = cml::subvector(w, N-4);
    vector_type::subvector_type xsub4(2.,3.,4.);
    equal_or_fail(sub4, xsub4);
