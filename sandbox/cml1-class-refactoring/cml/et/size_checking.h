...
#else
        CML_STATIC_REQUIRE_M(
                (size_t)LeftT::array_cols == right_traits::array_size,
                incompatible_expression_size_error);
#endif
...
#else
        CML_STATIC_REQUIRE_M(
                left_traits::array_size == (size_t)RightT::array_rows,
                incompatible_expression_size_error);
#endif
...
#else
        CML_STATIC_REQUIRE_M(
                left_traits::array_size == right_traits::array_size,
                incompatible_expression_size_error);

        /* Record the array size as a constant: */
        enum { array_size = left_traits::array_size };
#endif
...
#else
        enum { array_size = right_traits::array_size };
#endif
